...
- When updating rules, include a diff-style summary in the final response. Use `git diff --stat` first, then `git diff`, and limit the output to the rule files that changed.
